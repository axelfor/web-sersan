                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="fade-up text-center">
                        ...
                        <div className="mt-8 bg-white rounded-card p-8 border border-ocean-100 shadow-card text-left">
                            <p className="text-navy-800/70 leading-relaxed italic">
                                [Informasi sejarah koperasi akan diperbarui dengan data resmi. Bagian ini disediakan untuk menampilkan sejarah pendirian, perjalanan, dan perkembangan Koperasi Nelayan SERSAN.]
                            </p>
                            <p className="mt-4 text-navy-800/70 leading-relaxed">
                                Koperasi Nelayan SERSAN didirikan dengan latar belakang kebutuhan nelayan akan wadah bersama untuk saling mendukung dalam mengembangkan usaha dan meningkatkan kesejahteraan. Berawal dari inisiatif sekelompok nelayan yang memiliki visi yang sama, koperasi ini terbentuk sebagai upaya kolektif untuk membangun kemandirian ekonomi masyarakat pesisir.
                            </p>
                        </div>
                    </div>
                </div>
